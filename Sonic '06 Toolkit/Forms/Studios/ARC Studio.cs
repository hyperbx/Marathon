    ...
    public partial class ARC_Studio : Form
    {
        ...
        void mergeARC()
        {
            try
            {
                ...
                unpackBuildSession1.Append(Tools.Global.sessionID);
                ...
                arcBuildSession1.Append(Tools.Global.sessionID);
                ...
                Tools.Global.arcState = "processing";
                ...
                unpackBuildSession2electricboogaloo.Append(Tools.Global.sessionID);
                ...
                arcBuildSession2.Append(Tools.Global.sessionID);
