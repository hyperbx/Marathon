...
namespace Sonic_06_Toolkit
{
    public partial class Main : Form
    {
        public Main(string[] args)
        {
            ...
            if (args.Length > 0)
            {
                if (Path.GetExtension(args[0]) == ".arc")
                {
                    try
                    {
                        ...
                        var basicSession = new UTF8Encoding(true).GetBytes("\"" + Global.unpackFile + "\" \"" + arcBuildSession.ToString() + Path.GetFileName(args[0]) + "\"");
        ...
        void Themes_Compact_CheckedChanged(object sender, EventArgs e)
        {
            if (themes_Compact.Checked == true)
            {
                ...
                btn_NewTab.Width += 2; btn_NewTab.Height += 3; btn_NewTab.Left += 140; btn_NewTab.Top -= 29; btn_NewTab.BackColor = SystemColors.ControlLightLight; btn_NewTab.FlatAppearance.BorderSize = 1;
        ...
        void Themes_Original_CheckedChanged(object sender, EventArgs e)
        {
            if (themes_Original.Checked == true)
            {
                ...
                btn_NewTab.Width -= 2; btn_NewTab.Height -= 3; btn_NewTab.Left -= 140; btn_NewTab.Top += 29; btn_NewTab.BackColor = SystemColors.ControlLightLight; btn_NewTab.FlatAppearance.BorderSize = 0;
