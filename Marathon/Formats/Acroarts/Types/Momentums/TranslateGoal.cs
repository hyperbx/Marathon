...
namespace Marathon.Formats.Acroarts.Types.Momentums
{
    ...
    {
        public TranslateInfoSet Steps { get; set; }
        ...
        public void Read(BinaryObjectReaderEx in_reader)
        {
            ...
            {
                Steps = new TranslateInfoSet(in_reader);
            });
        ...
        public class TranslateInfoSet : List<TranslateInfo>, IMomentumParamSet
        {
            private List<long> _arrayPtrOffsets = [];

            public TranslateInfoSet() { }

            public TranslateInfoSet(BinaryObjectReaderEx in_reader)
            {
                Read(in_reader);
            }
            ...
            public void Read(BinaryObjectReaderEx in_reader)
            {
                ...
                foreach (var offset in offsets)
                {
                    in_reader.ReadAtOffset(in_reader.CalculateOffset(offset.UInt32), () =>
                    {
                        ...
                        {
                            Add(new TranslateInfo(in_reader));
                        });
                    });
                }
            }
        ...
        public class TranslateInfo : IMomentumParamSet
        {
            ...
            public TranslateInfo(BinaryObjectReaderEx in_reader)
            {
                Read(in_reader);
            }
