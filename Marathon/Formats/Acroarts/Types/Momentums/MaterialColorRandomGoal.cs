...
namespace Marathon.Formats.Acroarts.Types.Momentums
{
    ...
    {
        public IndirectMomentumParamList<MaterialColorRandomGoalInfo>[] Steps { get; set; } = new IndirectMomentumParamList<MaterialColorRandomGoalInfo>[4];
        ...
        public void Read(BinaryObjectReaderEx in_reader)
        {
            for (int i = 0; i < Steps.Length; i++)
            {
                ...
                {
                    Steps[i] = new IndirectMomentumParamList<MaterialColorRandomGoalInfo>(in_reader);
                });
            }
