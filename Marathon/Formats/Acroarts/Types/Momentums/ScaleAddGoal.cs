...
namespace Marathon.Formats.Acroarts.Types.Momentums
{
    ...
    {
        public IndirectMomentumParamList<ScaleAddGoalInfo> Steps { get; set; } = [];
        ...
        public void Read(BinaryObjectReaderEx in_reader)
        {
            ...
            {
                Steps = new IndirectMomentumParamList<ScaleAddGoalInfo>(in_reader);
            });
    ...
    public class ScaleAddGoalInfo : IMomentumParamSet
    {
        ...
        public ScaleAddGoalInfo(BinaryObjectReaderEx in_reader)
        {
            Read(in_reader);
        }
