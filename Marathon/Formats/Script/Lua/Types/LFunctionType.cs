...
namespace Marathon.Formats.Script.Lua.Types
{
    public class LFunctionType : BObjectType<LFunction>
    {
        ...
        public static void ParseMain(BinaryObjectReaderEx in_reader, BHeader in_header, LFunctionParseState in_state)
        {
        ...
        public static void ParseDebug(BinaryObjectReaderEx in_reader, BHeader in_header, LFunctionParseState in_state)
        {
        ...
        public static void ParseUpvalues(BinaryObjectReaderEx in_reader, BHeader in_header, LFunctionParseState in_state)
        {
