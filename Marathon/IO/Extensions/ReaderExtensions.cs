...
namespace Marathon.IO.Extensions
{
    public static class ReaderExtensions
    {
        ...
        public static bool CheckSignature<T>(this BinaryValueReader in_reader, T in_expected, T in_received, bool in_isExceptionOnInvalid = true) where T : unmanaged
        {
        ...
        {
            return CheckSignature(in_reader, in_expected, in_reader.Read<T>(), in_isExceptionOnInvalid);
        }

        public static bool CheckSignature(this BinaryValueReader in_reader, string in_expected, string in_received, bool in_isExceptionOnInvalid = true)
        {
            if (in_expected.Equals(in_received))
                return true;
        ...
        public static bool CheckSignature(this BinaryValueReader in_reader, string in_expected, bool in_isExceptionOnInvalid = true)
        {
            ...
            return CheckSignature(in_reader, in_expected, str, in_isExceptionOnInvalid);
        }
        ...
        public static void Align(this BinaryValueReader in_reader, int in_alignment)
        {
            in_reader.Seek(AlignmentHelper.Align(in_reader.Position, in_alignment), SeekOrigin.Begin);
        }
    }
}
